...
#' @param lambda Vector of BUM parameter \code{lambda}. lambda is the fraction
#'   of null (uniform distribution density) over all density.
#' @param a Vector of BUM parameter \code{a}, which corresponds to the a
#'   parameter of the beta distribution component. It describes the steepness of
